...
export default function CanvasPage() {
    ...
    // NIEUW: Background loading freeze state - blocks hover during image loading
					...
					canvas={
						...
						>
							<CanvasContent
								...
								effectiveStyles={canvasState.effectiveStyles} // <-- NIEUW
								highlightVisible={canvasState.highlightVisible} // <-- NEW: Highlight toggle
								// 3D transformation props
								lineTransforms={canvasState.lineTransforms}
								global3DSettings={canvasState.global3DSettings}
							/>
