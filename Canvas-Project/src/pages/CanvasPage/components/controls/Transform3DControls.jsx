...
import MultiSelectSlider from "./MultiSelectSlider";
			...
			>
				...
				{!hasSelection && (
					<div className={styles.gevelEffects}>
						...
						<div className={styles.controlGroup}>
							<label title="Pre-configured combinations of lighting and blend modes that simulate text on architectural surfaces. Works best with colored backgrounds and 3D transformations.">
								Gevel Presets ℹ️
							</label>
