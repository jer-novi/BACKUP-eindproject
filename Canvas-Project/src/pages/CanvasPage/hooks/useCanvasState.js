...
export function useCanvasState() {
	...
	const effectiveStyles = useMemo(() => {
		...
		// Debug log voor optimalisatie
		console.log("🚀 Text Optimization:", {
			enabled: isEnabled,
			resolution: styles.resolution,
			antialias: styles.antialias,
			roundPixels: styles.roundPixels,
			fontSize: fontSize,
			note: isEnabled
				? "Higher resolution texture, same visual size"
				: "Normal resolution",
		});
