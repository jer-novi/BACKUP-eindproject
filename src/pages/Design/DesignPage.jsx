...
export function DesignPage() {
	...
	useEffect(() => {
		if (dataSource && dataSource !== 'saved-design') {
			...
			// This allows sticky background behavior for new poems
			localStorage.removeItem('canvas_background_image');
		} else if (dataSource === 'saved-design') {
			console.log("🔒 DesignPage: Preserving saved design state, NOT clearing background cache");
		}
	}, [dataSource]);
